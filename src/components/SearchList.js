			...
			<div className="list-group-item">
				<div className="row">
					...
					<div className="col-md-4 col-sm-4 col-xs-4 text-right">
						<p className="badge"><span className="glyphicon glyphicon-star" aria-hidden="true"></span>&nbsp;{'Star ' + this.props.item.stargazers_count}</p>
						<br />
						<p className="badge"><span className="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp;{'Watch ' + this.props.item.watchers_count}</p>
						<br />
					</div>
				</div>
			</div>
